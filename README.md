...
## Reflection
This project reinforced that AI quality is not only model quality; it is workflow design, guardrails, and user interaction design working together. Gemini made profile adaptation more flexible, but deterministic fallbacks and strict validation were necessary to keep behavior stable and debuggable. The biggest problem-solving lesson was to treat recommendation behavior as a systems problem: data design, ranking constraints, CLI UX, and test coverage all had to evolve together to deliver reliable outcomes.
